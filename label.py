...
def read_tensor_from_image_file(file_name,
  ...
  print("image:{}".format(type(file_reader)))
  ...
  print(type(float_caster))
  dims_expander = tf.expand_dims(float_caster, 0)
  print(type(dims_expander))
...
if __name__ == "__main__":
  file_name = "/media/graymatics/backup/zachary/label/tensorflow/tensorflow/examples/label_image/data/image1.jpg"
  model_file = \
